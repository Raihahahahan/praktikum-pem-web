...
<body>
    ...
    <section class="container-login">
        ...
        <form action="form.php" class="form-login" method="post">
            ...
            <input type="text" name="nama" id="nama" placeholder="Masukkan Nama Akun Anda" class="formulir" required>
            <input type="password" name="password" id="password" placeholder="Masukkan Password Anda" class="formulir" required>
